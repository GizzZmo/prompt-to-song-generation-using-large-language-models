...
if __name__ == "__main__":
    ...
    writer = SummaryWriter(
        log_dir="tensorboard_logs/" + "lr_" + str(learning_rate).replace(".", "p") + "_mpt_" + str(mixed_precision_training)
    )
    ...
    checkpoint_save_dir = os.path.join(
        "models", "lr_" + str(learning_rate).replace(".", "p") + "_mpt_" + str(mixed_precision_training)
    )
